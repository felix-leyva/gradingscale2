...
$CertName = "CN=Grading Scale App"
$FSName = "grading-scale"
$PackageName = "GradingScale"
$Site = "https://github.com/felix-leyva/gradingscale2/releases/latest/download"
...
start "shell:appsFolder\GradingScale_6ga45kzqq6sx2!GradingScale"
